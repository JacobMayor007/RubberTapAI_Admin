...
export default function Dashboard() {
  ...
  const [activeTab, setActiveTab] = useState("feedbacks"); // Kept for the filtering logic
  ...
  useEffect(() => {
    ...
    // Ensure we start on the 'feedbacks' tab since 'reports' is gone
  ...
  // const currentItemsCount = filteredFeedbacks.length; // Not used in the final display
